...
public class DataStoreConfig {
	...
	public static final String REDIS_CACHE_NAME="redis_token_cache";//不为null即可
    public static final String REDIS_PREFIX ="cache_token";//不为null即可
	...
	@Bean
    RedisCache redisCache(@SuppressWarnings("rawtypes") RedisTemplate redisTemplate){
